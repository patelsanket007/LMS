    ...
    <div class="content"> 
      <div id="gallery">
        <figure>
          <figcaption>
              <div id="goal_img">
              <img src="images/concept_1.jpg"/>
              </div>
              <p>
              achieved by mugging the topics it is a long process which needs determination and for that here we have introduced five books
              which could enhance your ability and increase your knowledge for the competitive exams.
              </p>
              <br>
              <p style="text-indent: 5em;">
              One has to read the books thoroughly and answer the questions which are given in the question paper.
              " Practice makes a man perfect " so for practice we have created a set of 10 question papers each 
              consisting of 100 questions.
              </p>
              <br>
              <p style="text-indent: 5em;">
                  This material is based on <b style="color: red;">R.T.A concept (Reading, Thinking, Answering)</b>.The main strength of this 
                  concept is that it saves student time as in front of every question the book number and the page on which you 
                  will find the answer is given so that the student will not only find the answer but read the entire page and gain 
                  complete knowledge on that topic.
               </p>
               <br>
               <br>
               <div id="quote_g">
                   " Once you stop learning,<br><br>
                   <span id="secound">    you start dying. " </span>
               </div>
          </figcaption>
        </figure>
      </div>
