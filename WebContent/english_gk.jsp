...
<html lang="">
<head>
<title>Product - English GK</title>
<meta charset="utf-8">
...
<div class="wrapper row4">
  <nav id="mainav" class="hoc clear"> 
    <ul class="clear">
      ...
      <li class="active"><a class="drop" href="#">Product</a>
        <ul>
          <li><a href="gujarati_gk.jsp">Gujarati GK</a></li>
          <li class="active"><a href="english_gk.jsp">English GK</a></li>
        </ul>
      </li>
...
<div class="wrapper bgded overlay" style="background-color: grey; height: 500px;">
